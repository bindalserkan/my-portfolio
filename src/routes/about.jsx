    ...
    <div className="about-container">
      ...
      <div className="new-horizons-part">
        ...
        <p>
          ...
          many others worldwide. It gave me the opportunity to reset and explore
          new horizons.
        </p>
      </div>
      <div className="thankful-part">
        ...
        <p>
          ...
          one spark from a friend to set you on a whole new adventure. Thanks to
          him.🫶
        </p>
      </div>
      <div className="pixels-purrs-wonders-part">
        ...
        <p>
          ...
          thrill of on-site opportunities. But hey, while coding, I&apos;ve also got
          my little feline friend, my trusty sidekick, to keep me company on
          this adventure. And let&apos;s not forget the beautiful mother of nature,
          offering her wisdom and inspiration. So, here&apos;s to a career full of
          pixels, purrs, and the wonders of the great outdoors!💻😻🍂
        </p>
      </div>
    </div>
  );
